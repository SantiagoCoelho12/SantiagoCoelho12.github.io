...
Main.__name__ = true;
Main.main = function() {
	kha_System.start(new kha_SystemOptions("Obligatorio1",1280,720,new kha_WindowOptions("Obligatorio1",0,0,1280,720,null,true,1,0),new kha_FramebufferOptions()),function(w) {
...
com_loading_ResourceHandler.__name__ = true;
...
com_basicDisplay_SpriteSheetDB.__name__ = true;
...
com_collision_platformer_Body.__name__ = true;
...
com_collision_platformer_ICollider.__name__ = true;
...
com_collision_platformer_CollisionBox.__name__ = true;
...
com_collision_platformer_CollisionGroup.__name__ = true;
...
com_framework_Simulation.__name__ = true;
...
com_framework_utils_Entity.__name__ = true;
...
com_framework_utils_Input.__name__ = true;
...
com_framework_utils_JoystickProxy.__name__ = true;
...
com_framework_utils_Perlin.__name__ = true;
...
com_framework_utils_State.__name__ = true;
...
com_framework_utils_VirtualGamepad.__name__ = true;
...
com_framework_utils_VirtualButton.__name__ = true;
...
com_framework_utils_VirtualStick.__name__ = true;
...
com_gEngine_AnimationData.__name__ = true;
...
com_gEngine_DrawArea.__name__ = true;
...
com_gEngine_Filter.__name__ = true;
...
com_gEngine_FontData.__name__ = true;
...
com_gEngine_Frame.__name__ = true;
...
com_gEngine_GEngine.__name__ = true;
...
com_gEngine_Label.__name__ = true;
...
com_gEngine_PainterGarbage.__name__ = true;
...
com_gEngine_display_Blend.__name__ = true;
...
com_gEngine_display_Camera.__name__ = true;
...
com_gEngine_display_IDraw.__name__ = true;
...
com_gEngine_display_IAnimation.__name__ = true;
...
com_gEngine_display_IContainer.__name__ = true;
...
com_gEngine_display_IRotation.__name__ = true;
...
com_gEngine_display_Layer.__name__ = true;
...
com_gEngine_display_Sprite.__name__ = true;
...
com_gEngine_display_Stage.__name__ = true;
...
com_gEngine_display_StaticLayer.__name__ = true;
...
com_gEngine_display_Text.__name__ = true;
...
com_gEngine_helper_RectangleDisplay.__name__ = true;
...
com_gEngine_helper_Timeline.__name__ = true;
...
com_gEngine_painters_IPainter.__name__ = true;
...
com_gEngine_painters_PaintInfo.__name__ = true;
...
com_gEngine_painters_PaintMode.__name__ = true;
...
com_gEngine_painters_Painter.__name__ = true;
...
com_gEngine_painters_PainterAlpha.__name__ = true;
...
com_gEngine_painters_PainterColorTransform.__name__ = true;
...
com_gEngine_shaders_RenderPass.__name__ = true;
...
com_gEngine_shaders_ShDontRender.__name__ = true;
...
com_gEngine_shaders_ShRender.__name__ = true;
...
com_helpers_FastPoint.__name__ = true;
...
com_helpers_MinMax.__name__ = true;
...
com_helpers_Point.__name__ = true;
...
com_helpers_Rectangle.__name__ = true;
...
com_helpers_RenderTargetPool.__name__ = true;
...
com_helpers_ImageProx.__name__ = true;
...
com_imageAtlas_AtlasGenerator.__name__ = true;
...
com_imageAtlas_Bitmap.__name__ = true;
...
com_imageAtlas_ImageTree.__name__ = true;
...
com_imageAtlas_Node.__name__ = true;
...
com_loading_Resource.__name__ = true;
...
com_loading_AtlasJoinable.__name__ = true;
...
com_loading_Resources.__name__ = true;
...
com_loading_basicResources_TilesheetLoader.__name__ = true;
...
com_loading_basicResources_FontLoader.__name__ = true;
...
com_loading_basicResources_ImageLoader.__name__ = true;
...
com_loading_basicResources_JoinAtlas.__name__ = true;
...
com_loading_basicResources_SpriteSheetLoader.__name__ = true;
...
com_loading_basicResources_Sequence.__name__ = true;
com_loading_basicResources_Sequence.at = function(name,start,end) {
	var frames = [];
	var _g = start;
	var _g1 = end + 1;
	while(_g < _g1) frames.push(_g++);
...
com_soundLib_SoundManager.__name__ = true;
...
var gameObjects_Ball = function(layer,collisions,X,Y,i) {
	if(i == null) {
		i = 0;
	}
	if(Y == null) {
	...
	this.radio = 0;
	this.timer = 0;
	this.rotationMovement = 1;
	this.reverseBall = true;
	this.screenHeight = 0;
	this.screenWidth = 0;
	this.recentlyExploded = true;
	com_framework_utils_Entity.call(this);
	this.animation = new com_gEngine_display_Sprite("explosion");
	this.screenHeight = kha_System.windowHeight();
	this.screenWidth = kha_System.windowWidth();
	this.velocity = new kha_math_FastVector2(150,150);
	this.collisionGroup = collisions;
	this.display = new com_gEngine_display_Sprite("ball");
	this.collision = new com_collision_platformer_CollisionBox();
	if(X == 0 && Y == 0) {
		this.animation.scaleX = this.animation.scaleY = 1.5;
	}
	this.animation.offsetX = -30;
	this.animation.offsetY = 0;
	this.animation.timeline.playAnimation("sleep");
	...
	this.display.pivotY = tmp1 / 2;
	this.reverseBall = i == 1;
	if(X != 0 && Y != 0) {
		this.createSubBall(X,Y);
	} else {
		this.collisionGroup.add(this.collision);
		this.radio = 120;
		this.display.scaleX = this.display.scaleY = 0.5;
		var tmp2 = this.screenHeight;
		var tmp3 = Math.random();
		this.collision.x = tmp2 * tmp3;
		this.collision.y = 0;
		this.display.offsetX = -130;
		this.display.offsetY = -65;
		var tmp21 = this.display.width() * 0.5;
		this.collision.width = tmp21 - 17;
		var tmp31 = this.display.height() * 0.5;
		this.collision.height = tmp31 - 15;
		this.collision.userData = this;
	}
};
$hxClasses["gameObjects.Ball"] = gameObjects_Ball;
gameObjects_Ball.__name__ = true;
gameObjects_Ball.__super__ = com_framework_utils_Entity;
gameObjects_Ball.prototype = $extend(com_framework_utils_Entity.prototype,{
	recentlyExploded: null
	,display: null
	,collision: null
	,collisionGroup: null
	,screenWidth: null
	...
	,radio: null
	,animation: null
	,explosionChannel: null
	,update: function(dt) {
		com_framework_utils_Entity.prototype.update.call(this,dt);
		this.timer += dt;
		if(this.timer > 0.1) {
			this.recentlyExploded = false;
		}
		var _g = this.display;
		_g.set_rotation(_g.rotation + 0.020 * this.rotationMovement);
		if(this.reverseBall) {
			this.collision.x += this.velocity.x * dt * -1;
		} else {
			this.collision.x += this.velocity.x * dt;
		}
		this.velocity.y += 150 * dt;
		this.collision.y += this.velocity.y * dt;
		if(this.collision.x < 0 || this.collision.x + this.radio > this.screenWidth) {
			this.velocity.x *= -1;
			this.rotationMovement *= -1;
		}
		if(this.collision.y + this.radio > this.screenHeight * 0.90 || this.collision.y < 0) {
			this.velocity.y *= -1;
		}
	...
	,explode: function() {
		this.animation.x = this.display.x;
		this.animation.y = this.display.y;
		this.explosionChannel = kha_audio2_Audio1.play(kha_Assets.sounds.explosion);
		this.animation.timeline.playAnimation("explode",false);
	...
	,get_y: function() {
		return this.collision.y + this.collision.height * 0.5;
	}
	,createSubBall: function(X,Y) {
		this.collisionGroup.add(this.collision);
		this.radio = 60;
		this.display.scaleX = this.display.scaleY = 0.25;
		this.collision.x = X;
		this.collision.y = Y;
		this.display.offsetX = -129;
		this.display.offsetY = -95;
		var tmp = this.display.width() * 0.25;
		this.collision.width = tmp - 12;
		var tmp1 = this.display.height() * 0.25;
		this.collision.height = tmp1 - 10;
		this.collision.userData = this;
	}
...
gameObjects_Bullet.prototype = $extend(com_framework_utils_Entity.prototype,{
	...
	,shoot: function(x,y,dirX,dirY,bulletsCollision) {
		...
		this.collision.x = x;
		this.collision.y = y;
		this.collision.velocityX = 700 * dirX;
		this.collision.velocityY = 700 * dirY;
...
gameObjects_Gun.prototype = $extend(com_framework_utils_Entity.prototype,{
	bulletsCollisions: null
	,bullet: null
	,beep: null
	,shoot: function(aX,aY,dirX,dirY) {
		this.bullet = this.recycle(gameObjects_Bullet);
		this.bullet.shoot(aX,aY,dirX,dirY,this.bulletsCollisions);
		this.beep = kha_audio2_Audio1.play(kha_Assets.sounds.laser);
	}
...
var gameObjects_Player = function(X,Y,layer) {
	...
	this.display = new com_gEngine_display_Sprite("ship");
	this.collision = new com_collision_platformer_CollisionBox();
	this.currentLayer = layer;
	this.gun = new gameObjects_Gun();
	var tmp = this.display.width();
	this.collision.width = tmp * 0.8;
	var tmp1 = this.display.height();
	this.collision.height = tmp1 * 0.8;
	this.collision.x = X;
	this.collision.y = Y;
	this.collision.maxVelocityX = 700;
	this.collision.dragX = 0.91;
	this.collision.userData = this;
	this.display.offsetX = -38;
	this.display.offsetY = -10;
	var tmp2 = this.display.width();
	this.display.pivotX = tmp2 * 0.5;
	this.display.pivotY = this.display.height();
	layer.addChild(this.display);
...
gameObjects_Player.prototype = $extend(com_framework_utils_Entity.prototype,{
	...
	,update: function(dt) {
		...
		this.collision.update(dt);
		var _g = this.display;
		_g.set_rotation(_g.rotation + 0.002 * this.levitationX);
		this.collision.y += 0.12 * this.levitationY;
		if(this.display.rotation > 0.03 || this.display.rotation < -0.02) {
			this.levitationX *= -1;
		}
		if(this.collision.y > kha_System.windowHeight() * gameObjects_Player.PLAYER_Y + 3 || this.collision.y < kha_System.windowHeight() * gameObjects_Player.PLAYER_Y - 4) {
			this.levitationY *= -1;
		}
		if(this.isDead()) {
			this.explosion.y += 60 * dt;
		}
		if(this.collision.x > com_gEngine_GEngine.get_i().width) {
			this.collision.x = -this.collision.width;
		}
		if(this.collision.x + this.collision.width < 0) {
			this.collision.x = com_gEngine_GEngine.get_i().width;
		}
	}
	,render: function() {
		this.display.x = this.collision.x + this.collision.width * 0.5;
	...
	,onButtonChange: function(id,value) {
		if(id == 14) {
			if(value == 1) {
				this.collision.accelerationX = -gameObjects_Player.PLAYER_SPEED * 4;
				this.display.set_rotation(-0.05);
		...
		if(id == 0 && !com_framework_utils_Input.i.isKeyCodeReleased(32)) {
			this.gun.shoot(this.get_x() - 3,this.get_y() - 95,this.direction.x,-this.direction.y);
		}
	}
	...
	,die: function() {
		...
		this.explosion = new com_gEngine_display_Sprite("shipexplosion");
		this.explosion.x = this.display.x;
		this.explosion.y = this.display.y;
		this.explosion.scaleX = this.explosion.scaleY = 0.7;
		this.explosion.timeline.frameRate = 0.011111111111111112;
		this.explosion.offsetX = -70;
		this.explosion.offsetY = -20;
		this.explosion.timeline.playAnimation("explode",false);
		this.display.y = -1000;
		this.display.x = -1000;
		this.currentLayer.addChild(this.explosion);
	}
	,deathComplete: function() {
		return !this.explosion.timeline.playing;
	}
...
var kha__$Assets_ImageList = function() {
	this.shipexplosionDescription = { name : "shipexplosion", original_height : 963, file_sizes : [1523909], original_width : 2033, files : ["shipexplosion.png"], type : "image"};
	this.shipexplosion = null;
	this.shipDescription = { name : "ship", original_height : 76, file_sizes : [11586], original_width : 77, files : ["ship.png"], type : "image"};
	this.ship = null;
	this.gameOverDescription = { name : "gameOver", original_height : 267, file_sizes : [14315], original_width : 296, files : ["gameOver.png"], type : "image"};
	this.gameOver = null;
	this.explosionDescription = { name : "explosion", original_height : 256, file_sizes : [47839], original_width : 260, files : ["explosion.png"], type : "image"};
	this.explosion = null;
	this.bulletDescription = { name : "bullet", original_height : 66, file_sizes : [1172], original_width : 34, files : ["bullet.png"], type : "image"};
	this.bullet = null;
	this.ballDescription = { name : "ball", original_height : 256, file_sizes : [87298], original_width : 256, files : ["ball.png"], type : "image"};
	this.ball = null;
	this.backgroundDescription = { name : "background", original_height : 720, file_sizes : [1378375], original_width : 1280, files : ["background.png"], type : "image"};
	this.background = null;
	this.asteroidDescription = { name : "asteroid", original_height : 230, file_sizes : [19328], original_width : 250, files : ["asteroid.png"], type : "image"};
	this.asteroid = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,shipexplosion: null
	,shipexplosionDescription: null
	,__class__: kha__$Assets_ImageList
};
var kha__$Assets_SoundList = function() {
	this.laserDescription = { name : "laser", file_sizes : [9015,9194], files : ["laser.ogg","laser.mp3"], type : "sound"};
	this.laser = null;
	this.explosionDescription = { name : "explosion", file_sizes : [21679,38033], files : ["explosion.ogg","explosion.mp3"], type : "sound"};
	this.explosion = null;
};
...
var kha__$Assets_FontList = function() {
	...
	this.mainfont = null;
	this.GalaxyDescription = { name : "Galaxy", file_sizes : [58860], files : ["Galaxy.ttf"], type : "font"};
...
paths_Path.__name__ = true;
paths_Path.__isInterface__ = true;
paths_Path.prototype = {
	getPos: null
	,__class__: paths_Path
};
var paths_LinearPath = function(origin,end) {
	this.helperPos = new kha_math_FastVector2();
	this.origin = origin;
	this.end = end;
	...
	var _this_x = x;
	var _this_y = y;
	this.length = Math.sqrt(_this_x * _this_x + _this_y * _this_y);
};
$hxClasses["paths.LinearPath"] = paths_LinearPath;
paths_LinearPath.__name__ = true;
paths_LinearPath.__interfaces__ = [paths_Path];
paths_LinearPath.prototype = {
	helperPos: null
	,origin: null
	,end: null
	,length: null
	,getPos: function(s) {
		var _this = this.helperPos;
		var _this1 = this.origin;
		var _this2 = this.end;
		var vec = this.origin;
		var x = _this2.x - vec.x;
		var y = _this2.y - vec.y;
		if(y == null) {
			y = 0;
		}
		if(x == null) {
		...
		_this.x = x2;
		_this.y = y2;
		return this.helperPos;
	}
	,__class__: paths_LinearPath
};
...
states_GameOver.prototype = $extend(com_framework_utils_State.prototype,{
	...
	,load: function(resources) {
		...
		atlas.add(new com_loading_basicResources_FontLoader(kha_Assets.fonts.GalaxyName,30));
		resources.add(atlas);
	}
	,init: function() {
		...
		var textScore = new com_gEngine_display_Text(kha_Assets.fonts.GalaxyName);
		textScore.set_text("Tu puntaje es " + this.score);
		textScore.x = com_gEngine_GEngine.virtualWidth / 2 - textScore.width() * 0.63;
		textScore.y = com_gEngine_GEngine.virtualHeight * 0.46;
		textScore.set_color(kha__$Color_Color_$Impl_$.fromBytes(128,61,117));
		this.stage.addChild(textScore);
		var replay = new com_gEngine_display_Text(kha_Assets.fonts.GalaxyName);
		replay.x = com_gEngine_GEngine.virtualWidth * 0.22;
		replay.y = com_gEngine_GEngine.virtualHeight * 0.52;
		replay.set_color(kha__$Color_Color_$Impl_$.fromBytes(128,61,117));
		replay.set_text("Presione enter para jugar otra vez");
		this.stage.addChild(replay);
	}
	,update: function(dt) {
...
var states_GameState = function() {
	this.asteroidLevitationTimer = 0;
	this.asteroidLevitation = 0.8;
	this.asteroidTime = 0;
	this.count = 0;
	com_framework_utils_State.call(this);
};
...
states_GameState.prototype = $extend(com_framework_utils_State.prototype,{
	...
	,touchJoystick: null
	,ballsColiision: null
	,smallsBallsColiision: null
	,hudLayer: null
	,asteroidTime: null
	,asteroid: null
	,asteroidLevitation: null
	,asteroidLevitationTimer: null
	,load: function(resources) {
		this.screenWidth = com_gEngine_GEngine.get_i().width;
		this.screenHeight = com_gEngine_GEngine.get_i().height;
		var atlas = new com_loading_basicResources_JoinAtlas(2048,2048);
		atlas.add(new com_loading_basicResources_ImageLoader("background"));
		atlas.add(new com_loading_basicResources_ImageLoader("ship"));
		atlas.add(new com_loading_basicResources_ImageLoader("ball"));
		atlas.add(new com_loading_basicResources_ImageLoader("bullet"));
		atlas.add(new com_loading_basicResources_ImageLoader("asteroid"));
		atlas.add(new com_loading_basicResources_SpriteSheetLoader("explosion",51,64,0,[com_loading_basicResources_Sequence.at("ball",0,0),com_loading_basicResources_Sequence.at("explode",1,19),com_loading_basicResources_Sequence.at("sleep",19,19)]));
		atlas.add(new com_loading_basicResources_SpriteSheetLoader("shipexplosion",255,240,0,[com_loading_basicResources_Sequence.at("explode",0,21)]));
		atlas.add(new com_loading_basicResources_FontLoader(kha_Assets.fonts.GalaxyName,27));
		resources.add(atlas);
	}
	,init: function() {
		var backgraundLayer = new com_gEngine_display_Layer();
		this.background = new com_gEngine_display_Sprite("background");
		backgraundLayer.addChild(this.background);
		this.asteroid = new com_gEngine_display_Sprite("asteroid");
		this.asteroid.scaleX = this.asteroid.scaleY = 0.30;
		backgraundLayer.addChild(this.asteroid);
		this.path = new paths_LinearPath(new kha_math_FastVector2(530,-150),new kha_math_FastVector2(-600,800));
		this.stage.addChild(backgraundLayer);
		this.ballsColiision = new com_collision_platformer_CollisionGroup();
		this.smallsBallsColiision = new com_collision_platformer_CollisionGroup();
		...
		this.ship = new gameObjects_Player(kha_System.windowWidth() * Math.random(),kha_System.windowHeight() * gameObjects_Player.PLAYER_Y,this.simulationLayer);
		this.addChild(this.ship);
		GlobalGameData.player = this.ship;
		...
		this.score = new com_gEngine_display_Text(kha_Assets.fonts.GalaxyName);
		this.score.x = com_gEngine_GEngine.virtualWidth / 2.5;
		this.score.y = 30;
		var info = new com_gEngine_display_Text(kha_Assets.fonts.GalaxyName);
		info.x = com_gEngine_GEngine.virtualWidth * 0.33;
		info.y = 70;
		info.set_text("Espacio para disparar");
		this.hudLayer.addChild(info);
		this.hudLayer.addChild(this.score);
		this.addChild(new gameObjects_Ball(this.simulationLayer,this.ballsColiision));
		this.createTouchJoystick();
	}
	,update: function(dt) {
		if(this.ship.isDead() && this.ship.deathComplete()) {
			this.changeState(new states_GameOver(this.count));
		}
		com_framework_utils_State.prototype.update.call(this,dt);
		com_collision_platformer_CollisionEngine.overlap(this.ship.collision,this.ballsColiision,$bind(this,this.deathPlayer));
		com_collision_platformer_CollisionEngine.overlap(this.ship.collision,this.smallsBallsColiision,$bind(this,this.deathPlayer));
		com_collision_platformer_CollisionEngine.overlap(this.ship.gun.bulletsCollisions,this.ballsColiision,$bind(this,this.ballExplodes));
		com_collision_platformer_CollisionEngine.overlap(this.ship.gun.bulletsCollisions,this.smallsBallsColiision,$bind(this,this.smallBallExplodes));
		this.score.set_text("Puntaje " + "  " + this.count);
		if(com_framework_utils_Input.i.isKeyCodePressed(27)) {
			this.changeState(new states_GameState());
		}
		this.asteroidTime += dt;
		this.asteroidLevitationTimer += dt;
		if(this.asteroidTime > states_GameState.ASTEROID_CYCLE) {
			this.asteroidTime = 0;
		}
		var position = this.path.getPos(this.asteroidTime / states_GameState.ASTEROID_CYCLE);
		this.asteroid.x = position.x;
		this.asteroid.y = position.y + this.asteroidLevitation;
		if(this.asteroidLevitationTimer > 0.5) {
			this.asteroidLevitation *= -1;
			this.asteroidLevitationTimer = 0;
		}
	}
	,render: function() {
	...
	,createTouchJoystick: function() {
		...
		this.touchJoystick.notify(($_=this.ship,$bind($_,$_.onAxisChange)),($_=this.ship,$bind($_,$_.onButtonChange)));
		com_framework_utils_Input.i.getGamepad(0).notify(($_=this.ship,$bind($_,$_.onAxisChange)),($_=this.ship,$bind($_,$_.onButtonChange)));
	}
	,ballExplodes: function(a,b) {
		...
		ball.explode();
		this.count++;
		this.addChild(new gameObjects_Ball(this.simulationLayer,this.smallsBallsColiision,X,Y,0));
		this.addChild(new gameObjects_Ball(this.simulationLayer,this.smallsBallsColiision,X,Y,1));
	}
	,smallBallExplodes: function(a,b) {
		a.userData.die();
		var ball = b.userData;
...
gameObjects_Player.PLAYER_Y = 0.80;
gameObjects_Player.PLAYER_SPEED = 400;
...
states_GameState.ASTEROID_CYCLE = 11;
Main.main();
